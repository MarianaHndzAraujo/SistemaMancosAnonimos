      ...
      <div class="container">
        ...
        <form class="contenerdorform mt-5"  action="controlador.php" method="post">
          ...
          <div class="form-group">
            <label><b><h3>Usuario: </h3></b></label>
            <label><h3><?php echo $_REQUEST['usuR'] ?> </h3></label>
          </div>

          <input type="hidden" name="txtidElimina" value="<?php echo $_REQUEST['idR'] ?>">

          <button type="submit" name="btnElimina" class="btn btn-danger ">Si, Eliminar </button>
          <button type="submit" name="btnRegreso" class="btn btn-warning">No, Regresar </button>
