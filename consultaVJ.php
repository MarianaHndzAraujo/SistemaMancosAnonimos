...
<html >
  <head>
    <meta charset="utf-8">
    <title> Consulta Videojuegos </title>
...
<h1 class="display-3 text-center" style="color:dark;"><b>Registro Productos</b></h1>
      ...
      <?php
          ...
          while ($arrVJ=mysqli_fetch_array($rsVJ)) {
            echo"<tr>
                ...
                <td>".$arrVJ['precioA']."</td>
                <td>".$arrVJ['precioV']."</td>
                <td><a href='actualizarV.php?idR=".$arrVJ['idV']."&vjR=".$arrVJ['nombreV']."&vjC=".$arrVJ['consola']."&vjpa=".$arrVJ['precioA']."&vjpv=".$arrVJ['precioV']."'><img src=imagenes/upload.png></a></td>
                <td><a href='confirmaEliV.php?idR=".$arrVJ['idV']."&vjR=".$arrVJ['nombreV']."'><img src=imagenes/borrar.png></a></td>
                 </tr>";
          }
      ?>
      </tbody>
